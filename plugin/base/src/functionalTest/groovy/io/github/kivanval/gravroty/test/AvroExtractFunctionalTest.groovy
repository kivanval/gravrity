...
*/
package io.github.kivanval.gravroty.test

import io.github.kivanval.gravroty.util.TestUtils
...
class AvroExtractFunctionalTest extends Specification {
  ...
  def setup() {
    extractedOutputDir = Files
      .createDirectories(projectDir.resolve("build/extracted/sources/gravroty/avro/main"))
    buildFile = projectDir.resolve("build.gradle")
    buildFile << TestUtils.resource("sample.gradle")
  }

  def "task extracts nested archive with avro files"() {
    given:
