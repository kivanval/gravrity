...
*/
package io.github.kivanval.gravrity.task

import groovy.transform.CompileStatic
import io.github.kivanval.gravrity.util.AvroFileVisitor
...
class AvroExtract extends SourceTask {
  ...
  @TaskAction
  extract() {
    final def avroVisitor = project.objects.newInstance(AvroFileVisitor)
